...
ok($obj->html,qr/<input type=\"hidden\" id=\"value_test\" name=\"value_test\" value=\"1969-07-21\" \/>/);

$obj = HTML::Tag->new(element=>'DATE', name=>'another_test', value=>"");
ok($obj->html,qr/<input type=\"hidden\" id=\"another_test\" name=\"another_test\" value=\"\" \/>/);

$obj = HTML::Tag->new(element=>'DATE', name=>'ya_test', value=>"77868");
ok($obj->html,qr/<input type=\"hidden\" id=\"ya_test\" name=\"ya_test\" value=\"77868\" \/>/);
